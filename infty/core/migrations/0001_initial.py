# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-07-25 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hour_price_currency', models.PositiveSmallIntegerField(default=0, verbose_name=[(0, 'HUR'), (1, 'EUR'), (2, 'USD'), (3, 'CNY'), (4, 'RUB'), (5, 'JPY'), (6, 'INR')])),
                ('currency_exchange_source', models.TextField()),
                ('target_currency', models.PositiveSmallIntegerField(default=0, verbose_name=[(0, 'HUR'), (1, 'EUR'), (2, 'USD'), (3, 'CNY'), (4, 'RUB'), (5, 'JPY'), (6, 'INR')])),
                ('unit_of_target_currency_in_hour_price_currency', models.DecimalField(decimal_places=8, default=0.0, max_digits=20)),
                ('value', models.DecimalField(decimal_places=8, default=0.0, max_digits=20)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_currency', models.PositiveSmallIntegerField(default=0, verbose_name=[(0, 'HUR'), (1, 'EUR'), (2, 'USD'), (3, 'CNY'), (4, 'RUB'), (5, 'JPY'), (6, 'INR')])),
